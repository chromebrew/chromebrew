...
class Xdg_dbus_proxy < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/xdg_dbus_proxy-0.1.2-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/xdg_dbus_proxy-0.1.2-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/xdg_dbus_proxy-0.1.2-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/xdg_dbus_proxy-0.1.2-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
