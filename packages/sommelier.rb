...
#   system 'git clone https://chromium.googlesource.com/chromiumos/containers/sommelier'
    system 'git clone https://chromium.googlesource.com/chromiumos/platform2/+/master/vm_tools/sommelier/'
    Dir.chdir ("sommelier") do
#      system "git reset --hard 59dd453e6efd2c4a0b2b08767c42f47e66a4aaa1"
