...
class Libticonv < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libticonv/1.1.5_armv7l/libticonv-1.1.5-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libticonv/1.1.5_armv7l/libticonv-1.1.5-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libticonv/1.1.5_i686/libticonv-1.1.5-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libticonv/1.1.5_x86_64/libticonv-1.1.5-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
