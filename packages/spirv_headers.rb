...
class Spirv_headers < Package
  ...
  binary_url({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/spirv_headers-1.5.4-f88a-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/spirv_headers-1.5.4-f88a-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/spirv_headers-1.5.4-f88a-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/spirv_headers-1.5.4-f88a-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
