...
class Nginx < Package
  ...
  def self.install
    ...
    system "install -Dm755 startnginx #{CREW_DEST_PREFIX}/bin/startnginx"
    system "install -Dm755 stopnginx #{CREW_DEST_PREFIX}/bin/stopnginx"
  end
  ...
  def self.postinstall
    ...
    puts "echo 'if [ -f #{CREW_PREFIX}/bin/startnginx ]; then' >> #{CREW_PREFIX}/etc/env.d/profile".lightblue
    puts "echo '  #{CREW_PREFIX}/bin/startnginx' >> #{CREW_PREFIX}/etc/env.d/profile".lightblue
