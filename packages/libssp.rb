...
class Libssp < Package
  ...
  binary_url({
    aarch64: 'https://github.com/chromebrew/binaries/releases/download/v_gcc10_10.3.0/libssp-10.3.0-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/releases/download/v_gcc10_10.3.0/libssp-10.3.0-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/releases/download/v_gcc10_10.3.0/libssp-10.3.0-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/releases/download/v_gcc10_10.3.0/libssp-10.3.0-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
