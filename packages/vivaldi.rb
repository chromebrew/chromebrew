...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '42791913580081b447631f5a1666ada6b9a8260adcbee5489a4ed93ef5965cd9'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'ee49100956047f33ae703eed1d048a581ae7d7f0608c5ee7f18e2cfa117f44be'
  end
