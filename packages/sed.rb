...
class Sed < Autotools
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/sed/4.9-1_armv7l/sed-4.9-1-chromeos-armv7l.tar.zst',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/sed/4.9-1_armv7l/sed-4.9-1-chromeos-armv7l.tar.zst',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/sed/4.9-1_i686/sed-4.9-1-chromeos-i686.tar.zst',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/sed/4.9-1_x86_64/sed-4.9-1-chromeos-x86_64.tar.zst'
  })
  binary_sha256({
