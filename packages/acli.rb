...
class Acli < Package
  ...
  def self.install
    ...
    abort 'Checksum mismatch. :/ Try again.'.lightred unless Digest::SHA256.hexdigest( File.read('acli.phar') ) == 'e0b7840600e8cb31cb916b4f98dce03ee3f60eb052c073abd9953cc42fd3577e'
