...
class Composer < Package
  ...
  def self.install
    ...
    abort 'Checksum mismatch. :/ Try again.'.lightred unless Digest::SHA256.hexdigest( File.read('composer') ) == '1d58486b891e59e9e064c0d54bb38538f74d6014f75481542c69ad84d4e97704'
