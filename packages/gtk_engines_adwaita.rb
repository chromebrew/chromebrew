...
class Gtk_engines_adwaita < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/gtk_engines_adwaita-3.27.92-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/gtk_engines_adwaita-3.27.92-chromeos-armv7l.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/gtk_engines_adwaita-3.27.92-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
