...
class Biew < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/biew-6.1.0-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/biew-6.1.0-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/biew-6.1.0-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/biew-6.1.0-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
