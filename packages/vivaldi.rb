...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '8044303343483eb61d8862b5a630a1bd252dfecec893cbd7d9ce21ccbd3a56e1'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '7911d068aced7faea8f45a023524725d2e47b7a779d464e294d3b90f122d502c'
  end
