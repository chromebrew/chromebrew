...
class Newlisp < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/newlisp/10.7.5_armv7l/newlisp-10.7.5-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/newlisp/10.7.5_armv7l/newlisp-10.7.5-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/newlisp/10.7.5_i686/newlisp-10.7.5-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/newlisp/10.7.5_x86_64/newlisp-10.7.5-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
