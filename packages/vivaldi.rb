...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '64c7e1bd944280e002dbd5f5fd9d64965b37fcc1ceec0d29b209a4ff75b695c2'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'e53cb8f394e40843743401f4586db85f3f87401e7b65cd0e7d308b5bff244f4e'
  end
