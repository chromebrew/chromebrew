...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '35e499415819dc228b2e4db35c3550aab6a440d199208fca042a72cdb89de4f9'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'a35f59d2fd8d1d1ff05074306f4980fb99fd59e6cdf0fad5bdd34e1db2ecd735'
  end
