...
class Bashdb < Package
  ...
  binary_url({
    aarch64: 'https://dl.bintray.com/chromebrew/chromebrew/bashdb-5.0-1.1.2-abac-chromeos-armv7l.tar.xz',
     armv7l: 'https://dl.bintray.com/chromebrew/chromebrew/bashdb-5.0-1.1.2-abac-chromeos-armv7l.tar.xz',
       i686: 'https://dl.bintray.com/chromebrew/chromebrew/bashdb-5.0-1.1.2-abac-chromeos-i686.tar.xz',
     x86_64: 'https://dl.bintray.com/chromebrew/chromebrew/bashdb-5.0-1.1.2-abac-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
