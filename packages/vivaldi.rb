...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '89a0ed3d318f4f0fb3c30fc4074aecbc6879cabd6696ee1be388ada8e32c6f5a'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '6082bb01fe1cb9226effa0109a92d48c5249ef494a856120d77f4ee346e9a5f1'
  end
