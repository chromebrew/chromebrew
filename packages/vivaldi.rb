...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '2205532b37fa72584a4e1fa9b948e6831f59340de9da090c25a25759a8912d67'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'ff306f1f4210649afc3ca5a42339cf47134b331428c553a70eb030fb40563843'
  end
