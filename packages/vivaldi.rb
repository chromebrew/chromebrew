...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'a4db03171a800e72df795b0184157d92e60356c64b8f1545f173296cf1c85090'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '345bc74a6306ae1bc558c475a27c247126140967b5d7e08ed6398e94cbfda75f'
  end
