...
class Openjpeg < CMake
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/openjpeg/2.5.0-1_armv7l/openjpeg-2.5.0-1-chromeos-armv7l.tar.zst',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/openjpeg/2.5.0-1_armv7l/openjpeg-2.5.0-1-chromeos-armv7l.tar.zst',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/openjpeg/2.5.0-1_x86_64/openjpeg-2.5.0-1-chromeos-x86_64.tar.zst'
  })
  binary_sha256({
