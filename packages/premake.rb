...
class Premake < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/premake-5.0.0-alpha15-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/premake-5.0.0-alpha15-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/premake-5.0.0-alpha15-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/premake-5.0.0-alpha15-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
  ...
  def self.install
    ...
    FileUtils.install 'bin/release/premake5', "#{CREW_DEST_PREFIX}/bin/premake", mode: 0755
  end
