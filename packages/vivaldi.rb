...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'b5b2007c7d4db77d1f3cef39177464dc60472cc66b5e8e274e5396f0e42aabf7'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'c30e1b8cca7017899f0231e9cc77ce761b48e97395e71d9526eca3c3ec7a39d0'
  end
