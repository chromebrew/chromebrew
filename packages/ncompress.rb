...
class Ncompress < Package
  ...
  binary_url({
     aarch64: 'file:///usr/local/tmp/packages/ncompress-5.0-chromeos-armv7l.tar.zst',
      armv7l: 'file:///usr/local/tmp/packages/ncompress-5.0-chromeos-armv7l.tar.zst',
        i686: 'file:///usr/local/tmp/packages/ncompress-5.0-chromeos-i686.tar.zst',
      x86_64: 'file:///usr/local/tmp/packages/ncompress-5.0-chromeos-x86_64.tar.zst'
  })
  binary_sha256({
