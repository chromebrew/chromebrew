...
class Libmypaint < Package
  ...
  binary_url({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/libmypaint-1.6.1-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/libmypaint-1.6.1-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/libmypaint-1.6.1-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/libmypaint-1.6.1-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
