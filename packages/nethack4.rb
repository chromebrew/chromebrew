...
class Nethack4 < Package
  ...
  binary_url ({
      i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/nethack4-4.3.0-beta2-1-chromeos-i686.tar.xz',
    x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/nethack4-4.3.0-beta2-1-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
