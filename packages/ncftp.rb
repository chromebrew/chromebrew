...
class Ncftp < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/ncftp/3.2.6_armv7l/ncftp-3.2.6-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/ncftp/3.2.6_armv7l/ncftp-3.2.6-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/ncftp/3.2.6_i686/ncftp-3.2.6-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/ncftp/3.2.6_x86_64/ncftp-3.2.6-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
