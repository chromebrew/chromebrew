...
class Gnome_docking_library < Package
  ...
  binary_url ({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/gnome_docking_library-3.28.0-0-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/gnome_docking_library-3.28.0-0-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/gnome_docking_library-3.28.0-0-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/gnome_docking_library-3.28.0-0-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
