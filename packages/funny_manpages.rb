...
class Funny_manpages < Package
  ...
  def self.install
    ...
    FileUtils.install 'man/*.1fun', "#{CREW_DEST_MAN_PREFIX}/man1", mode: 0o644, verbose: true
    FileUtils.install 'man/*.3fun', "#{CREW_DEST_MAN_PREFIX}/man3", mode: 0o644, verbose: true
    FileUtils.install 'man/*.6fun', "#{CREW_DEST_MAN_PREFIX}/man6", mode: 0o644, verbose: true
