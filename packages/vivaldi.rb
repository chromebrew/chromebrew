...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'd14801f7053a7c205f6c01589f925aa8db4c5a865af49ffd0d420974dbdce913'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'f64f3e9461795ccb451952ff9a8b56f8478769538c06683f050f4699b48ab21f'
  end
