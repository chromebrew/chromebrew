...
class Gcc7 < Package
  ...
  def self.install
    Dir.chdir("objdir") do
      ...
      # The installation stage puts some files used by gdb under the #{CREW_LIB_PREFIX}(64) directory. This generates spurious error messages when performing ldconfig. This command moves the files to another location.
