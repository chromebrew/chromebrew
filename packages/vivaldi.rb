...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '838a334dae96b527cbe1cd7f50124cdf2e0e5538c056b40218583df97150e17c'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '7a0c23f65f9a8c41296ab0c84f4e07212f32b75942381069ef19d00cc59b04fa'
  end
