...
class Perl < Package
  description 'Perl 5 is a highly capable, feature-rich programming language with over 29 years of development. https://www.perl.org/'
  homepage 'https://www.perl.org/get.html'
  version '5.26.1'
