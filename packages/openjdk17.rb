...
class Openjdk17 < Package
  ...
  compatibility 'all'
  source_url({
    aarch64: 'https://cdn.azul.com/zulu/bin/zulu17.36.17-ca-jdk17.0.4.1-linux_aarch64.tar.gz',
  ...
  source_sha256({
    aarch64: '8e8b7fa243a152b79527651a47a255f4db91c7886b32de14fb2787a2a6aa51dc',
