...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '5d7eb5401fdb27aa701a27d52a20be4656df6820f1e2769f76912b73f96a46cd'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'a20157df87ad4d4930abdfd144d2f2a0c141443598f9cbff0ab9f51f79373805'
  end
