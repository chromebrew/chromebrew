...
class Vim < Package
  ...
  def self.install
    ...
    system "cp #{CREW_DEST_PREFIX}/share/vim/vim81/vimrc_example.vim #{CREW_DEST_PREFIX}/share/vim/vim81/vimrc"
  end
  ...
  def self.postinstall
    ...
    puts "ln -s #{CREW_PREFIX}/share/vim/vim81 ~/.vim".lightblue
