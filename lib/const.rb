...
CREW_LOCALESTATE_PREFIX = CREW_PREFIX + '/var'
...
CREW_REPO_DIR = CREW_LOCALESTATE_PREFIX + '/crew/repo'
...
CREW_DEST_LOCALSTATE_PREFIX = CREW_DEST_DIR + CREW_LOCALESTATE_PREFIX
