...
CREW_MESON_OPTIONS = "-Dprefix=#{CREW_PREFIX} -Dlibdir=#{CREW_LIB_PREFIX} -Ddatadir=#{CREW_LIB_PREFIX} -Dmandir=#{CREW_MAN_PREFIX} -Dbuild=#{CREW_BUILD} -Dhost=#{CREW_BUILD} -Dtarget=#{CREW_BUILD} -Dbuildtype=release"
