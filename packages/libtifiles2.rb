...
class Libtifiles2 < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libtifiles2/1.1.7_armv7l/libtifiles2-1.1.7-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libtifiles2/1.1.7_armv7l/libtifiles2-1.1.7-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libtifiles2/1.1.7_i686/libtifiles2-1.1.7-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libtifiles2/1.1.7_x86_64/libtifiles2-1.1.7-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
