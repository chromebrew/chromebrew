...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '8fe304db7a2558159301d4a2e8ec8b5867cc67ba32b948391bfef80de9a9b801'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'f29516d88f7a3224594f19a37668572baddb2e0046b825d23cf32837b4c0faf3'
  end
