...
class Aspell_fr < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/aspell_fr-0.50-3-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/aspell_fr-0.50-3-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/aspell_fr-0.50-3-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/aspell_fr-0.50-3-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
