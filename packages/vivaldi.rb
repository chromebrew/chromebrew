...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'adef8b32ffebb5b353a0acd3d24587fcf095433f3e8ded980bf80e0498a954c9'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'ffb1f9ea4fc7eb9e99274f13a771999682ab1eef078641df6fcd48c1357ffd7a'
  end
