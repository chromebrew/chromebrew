...
class Crew_profile_base < Package
  ...
  binary_url({
    aarch64: 'https://dl.bintray.com/chromebrew/chromebrew/crew_profile_base-0.0.1-pre6-chromeos-armv7l.tar.xz',
     armv7l: 'https://dl.bintray.com/chromebrew/chromebrew/crew_profile_base-0.0.1-pre6-chromeos-armv7l.tar.xz',
       i686: 'https://dl.bintray.com/chromebrew/chromebrew/crew_profile_base-0.0.1-pre6-chromeos-i686.tar.xz',
     x86_64: 'https://dl.bintray.com/chromebrew/chromebrew/crew_profile_base-0.0.1-pre6-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
