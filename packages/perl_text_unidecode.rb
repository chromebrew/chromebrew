...
class Perl_text_unidecode < Package
  ...
  binary_url ({
    aarch64: 'https://github.com/jam7/chromebrew/releases/download/bin-armv7l/perl_text_unidecode-1.30-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/jam7/chromebrew/releases/download/bin-armv7l/perl_text_unidecode-1.30-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/jam7/chromebrew/releases/download/bin-i686/perl_text_unidecode-1.30-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/jam7/chromebrew/releases/download/bin-x86_64/perl_text_unidecode-1.30-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
