...
class Rkhunter < Package
  ...
  binary_url ({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/rkhunter/1.4.4-1_armv7l/rkhunter-1.4.4-1-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/rkhunter/1.4.4-1_armv7l/rkhunter-1.4.4-1-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/rkhunter/1.4.4-1_i686/rkhunter-1.4.4-1-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/rkhunter/1.4.4-1_x86_64/rkhunter-1.4.4-1-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
