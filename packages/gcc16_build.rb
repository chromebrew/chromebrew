...
class Gcc16_build < Package
  ...
  binary_sha256({
    aarch64: '960e857ee37476febd2cc0851e1b9b147249442ce501df32c5c0609552a63e8f',
     armv7l: '960e857ee37476febd2cc0851e1b9b147249442ce501df32c5c0609552a63e8f',
       i686: '134606a102e096559a3009622c64872d3203caff135d8378b2db0425a4c8c217',
     x86_64: 'abd770fa243abac859b36715ce1221aafc66fc7b45e625a251162ea66c7e88b6'
  })
  ...
  def self.prebuild
    ...
    when 'i686'
      ...
      FileUtils.ln_sf(["#{CREW_LIB_PREFIX}/crt1.o", "#{CREW_LIB_PREFIX}/crtn.o", "#{CREW_LIB_PREFIX}/crti.o"], "#{CREW_PREFIX}/i686-cros-linux-gnu/lib/", verbose: true)
    when 'x86_64'
      FileUtils.mkdir_p "#{CREW_PREFIX}/x86_64-cros-linux-gnu/lib"
      FileUtils.ln_sf(["#{CREW_LIB_PREFIX}/crt1.o", "#{CREW_LIB_PREFIX}/crtn.o", "#{CREW_LIB_PREFIX}/crti.o"], "#{CREW_PREFIX}/x86_64-cros-linux-gnu/lib/", verbose: true)
    when 'armv7l', 'aarch64'
      FileUtils.mkdir_p "#{CREW_PREFIX}/armv7l-cros-linux-gnueabihf/lib"
      FileUtils.ln_sf(["#{CREW_LIB_PREFIX}/crt1.o", "#{CREW_LIB_PREFIX}/crtn.o", "#{CREW_LIB_PREFIX}/crti.o"], "#{CREW_PREFIX}/armv7l-cros-linux-gnueabihf/lib/", verbose: true)
    end
  end
  ...
  def self.build
    @gcc_global_opts = <<~OPT.chomp
      ...
      --with-target-libxml2-lib=#{CREW_LIB_PREFIX}
    OPT
    ...
    Dir.chdir('objdir') do
      ...
      system "export LIBRARY_PATH=#{CREW_LIB_PREFIX} ; ( make -j#{CREW_NPROC} || make -j#{CREW_NPROC} || make -j1 )"
    end
  end
