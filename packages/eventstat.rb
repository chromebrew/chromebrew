...
class Eventstat < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/eventstat/0.04.07_armv7l/eventstat-0.04.07-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/eventstat/0.04.07_armv7l/eventstat-0.04.07-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/eventstat/0.04.07_i686/eventstat-0.04.07-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/eventstat/0.04.07_x86_64/eventstat-0.04.07-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
