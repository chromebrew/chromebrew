...
class Azure_cli < Package
  ...
  binary_url({
      i686: 'https://github.com/chromebrew/binaries/raw/main/i686/azure_cli-2.21.0-chromeos-i686.tar.xz',
    x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/azure_cli-2.21.0-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
