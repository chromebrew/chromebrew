...
class Monero_gui < Package
  ...
  source_url 'https://downloads.getmonero.org/gui/monero-gui-linux-x64-v0.17.2.3.tar.bz2'
  source_sha256 'f011ba2bd67395ca8c17d5faf1397785905533dd1a8b9ebf1e6810d0f726f40f'
