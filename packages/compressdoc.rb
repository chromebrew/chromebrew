...
class Compressdoc < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/compressdoc-20080421.1623-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/compressdoc-20080421.1623-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/compressdoc-20080421.1623-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/compressdoc-20080421.1623-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
