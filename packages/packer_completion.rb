...
class Packer_completion < Package
  ...
  binary_url({
    aarch64: 'https://dl.bintray.com/chromebrew/chromebrew/packer_completion-1.0.0-1-chromeos-armv7l.tar.xz',
     armv7l: 'https://dl.bintray.com/chromebrew/chromebrew/packer_completion-1.0.0-1-chromeos-armv7l.tar.xz',
       i686: 'https://dl.bintray.com/chromebrew/chromebrew/packer_completion-1.0.0-1-chromeos-i686.tar.xz',
     x86_64: 'https://dl.bintray.com/chromebrew/chromebrew/packer_completion-1.0.0-1-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
