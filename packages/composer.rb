...
class Composer < Package
  ...
  def self.install
    ...
    abort 'Checksum mismatch. :/ Try again.'.lightred unless Digest::SHA256.hexdigest( File.read('composer') ) == 'cb8b04cc6a6fb167403f7495e8539650eb555657aa48873f115383bcd8f0b18d'
