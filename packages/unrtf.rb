...
class Unrtf < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/unrtf/0.21.9_armv7l/unrtf-0.21.9-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/unrtf/0.21.9_armv7l/unrtf-0.21.9-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/unrtf/0.21.9_i686/unrtf-0.21.9-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/unrtf/0.21.9_x86_64/unrtf-0.21.9-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
