...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '48a1e46db7d920863661b25f2a839b2c4637aef5c7b5d09f77e18994b9f571ed'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'f54eef3ef9826f08246062196e52a086ea8296139f192110a9356468381cd0cb'
  end
