...
class Hunspell_base < Package
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/hunspell_base/1.7.0-1_armv7l/hunspell_base-1.7.0-1-chromeos-armv7l.tar.xz',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/hunspell_base/1.7.0-1_armv7l/hunspell_base-1.7.0-1-chromeos-armv7l.tar.xz',
       i686: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/hunspell_base/1.7.0-1_i686/hunspell_base-1.7.0-1-chromeos-i686.tar.xz',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/hunspell_base/1.7.0-1_x86_64/hunspell_base-1.7.0-1-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
