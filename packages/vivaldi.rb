...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'ce7e39c2d5d6a689f0838faeafc456a8db3b5404906c466073997e9b70edf060'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '5a1a2f32f7610666ef361939359c6222f6290c4b5160dfaeebd55b270a5ecf94'
  end
