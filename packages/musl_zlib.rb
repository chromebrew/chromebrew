...
class Musl_zlib < Package
  ...
  binary_sha256({
    aarch64: '3c9da8c456f08d29242000822cbffff6fdce77e5d20c1db5951a315d38445a6d',
     armv7l: '3c9da8c456f08d29242000822cbffff6fdce77e5d20c1db5951a315d38445a6d',
       i686: 'ff74472391310a01ea7e569007dcee2bc62a68a8963eaf9afc26b3dc89aaafd5',
     x86_64: 'bf760e380efbcb089f8b809b143132de49ebb92a3d236c1ce719535ce3c87345'
  })
  ...
  @ldflags = "-L#{CREW_PREFIX}/musl/#{ARCH_LIB} -flto -static"
  @cmake_ldflags = '-flto'
  @musldep_cmake_options = "PATH=#{CREW_PREFIX}/musl/bin:#{CREW_PREFIX}/musl/#{ARCH}-linux-musl#{@abi}/bin:#{ENV['PATH']} \
        ...
        -DCMAKE_LIBRARY_PATH='#{CREW_PREFIX}/musl/#{ARCH_LIB}' \
  ...
  @musldep_env_options = "PATH=#{CREW_PREFIX}/musl/bin:#{ENV['PATH']} \
      ...
      CXX='#{CREW_PREFIX}/musl/bin/#{ARCH}-linux-musl#{@abi}-g++' \
      LD=#{CREW_PREFIX}/musl/bin/#{ARCH}-linux-musl#{@abi}-ld.gold \
      PKG_CONFIG_LIBDIR=#{CREW_PREFIX}/musl/#{ARCH_LIB} \
      CFLAGS='#{@cflags}' \
      CXXFLAGS='#{@cxxflags}' \
      CPPFLAGS='-I#{CREW_PREFIX}/musl/include -fcommon' \
      LDFLAGS='#{@ldflags}'"
