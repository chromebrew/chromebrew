...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '8cc5c191f9fea055668b531589a25a81f939323edcfd8b1a92541dce3588da73'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '731907a850a9f81ae881a1a31e7f07b7f59c6096d031fb112d2351b322181a5b'
  end
