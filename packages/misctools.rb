...
class Misctools < Package
  ...
  binary_url ({
      i686: 'https://github.com/chromebrew/binaries/raw/main/i686/misctools-2.6-chromeos-i686.tar.xz',
    x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/misctools-2.6-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
