...
class Shotcut < Package
  ...
  source_url 'https://github.com/mltframework/shotcut/releases/download/v23.05.14/shotcut-linux-x86_64-230514.txz'
  source_sha256 '38e1f32e0211043feae7b2a075caad978f2897c24502ab880b5bef30e6539695'

  binary_url({
    x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/shotcut/23.05.14_x86_64/shotcut-23.05.14-chromeos-x86_64.tar.zst'
  })
  binary_sha256({
    x86_64: '30f56af633399525b4f97ebd286de279524fa62966133c5889715acfc439362a'
  })
  ...
  def self.preflight
    abort 'Shotcut requires glibc > 2.29.' if Gem::Version.new(LIBC_VERSION.to_s) < Gem::Version.new('2.29')
  end
