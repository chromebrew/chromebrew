...
class Hunspell_fr_fr < Package
  ...
  binary_url({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/hunspell_fr_fr-1.7.0-2-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/hunspell_fr_fr-1.7.0-2-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/hunspell_fr_fr-1.7.0-2-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/hunspell_fr_fr-1.7.0-2-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
