...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    @_arch = 'armhf'
    source_sha256 '6535790b76c0618d7fea82dddf27d020422a1b5aa5321e4d6e9938bd47976c59'
  when 'x86_64'
    @_arch = 'amd64'
    source_sha256 '0b6abca95821f12d4feadfaa30839348cddf2cdfc8b5d652fa884275050f0233'
  end
