...
class Oneko < Package
  ...
  def self.patch
    ...
    download_file('https://httpredir.debian.org/debian/pool/main/o/oneko/oneko_1.2.sakura.6-15.debian.tar.xz')
    download_file('https://bouncer.gentoo.org/fetch/root/all/distfiles/oneko-1.2-cat.png')
    download_file('https://bouncer.gentoo.org/fetch/root/all/distfiles/oneko-1.2-dog.png')
    # Verify the sources
    @sha256sums = <<~EOF
