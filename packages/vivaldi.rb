...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '5f934ce1172d4592ceceff1def94d9e396bee4f786a2a2d93169dcfb9e35b727'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '921b6257cc7f11cd9105005135d7d65f0a907b361a2ca0671aa6e93961053c3d'
  end
