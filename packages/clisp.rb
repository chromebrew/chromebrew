...
class Clisp < Package
  ...
  binary_url ({
      i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/clisp-2.49-3-chromeos-i686.tar.xz',
    x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/clisp-2.49-3-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
