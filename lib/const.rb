...
CREW_LOCAL_REPO_ROOT ||= Kernel.system("#{CREW_PREFIX}/bin/git --version", %i[out err] => File::NULL)) ? `git rev-parse --show-toplevel 2> /dev/null`.chomp : '' unless defined?(CREW_LOCAL_REPO_ROOT)
