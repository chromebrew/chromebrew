...
exclusions+=' perl_xml_simple.rb pipes_sh.rb pipesx_sh.rb platformsh.rb pngcheck.rb powershell.rb pup.rb pycharm.rb qtcreator.rb sl.rb sommelier.rb spark.rb'
exclusions+=' squeak.rb stack.rb sublime_merge.rb sublime_text.rb symfony.rb terminus.rb terraform.rb thefuck.rb tinycore.rb tkdiff.rb txt2regex.rb uthash.rb uwsgi.rb'
