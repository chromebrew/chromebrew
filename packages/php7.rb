...
class Php7 < Package
  version '7.1.1'
  source_url 'http://php.net/distributions/php-7.1.1.tar.xz'   # software source tarball url
  source_sha1 '167b98868e2b8f77495053c5e050d5e8a955da26'       # source tarball sha1 sum
