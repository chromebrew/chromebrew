...
class Busybox < Package
  ...
  license 'GPL-3'
  compatibility 'all'
  source_url 'https://busybox.net/downloads/busybox-1.33.0.tar.bz2'
  ...
  def self.patch
    @busyboxconfig = <<~BUSYBOXCONFIGEOF
      ...
      CONFIG_SYSROOT=""
      CONFIG_EXTRA_CFLAGS="-pipe -O2 -fuse-ld=gold -flto=auto -fomit-frame-pointer"
      CONFIG_EXTRA_LDFLAGS="-flto=auto"
