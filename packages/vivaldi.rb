...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'c358e81886e679abb63bd4f3e3ad52b1cfac04f1873a707eda26f955756a5fa6'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '84bcaaf3ac9d6c4cd4f9c11a620da4439b8374cf1b2361b71cf5a254f1409509'
  end
