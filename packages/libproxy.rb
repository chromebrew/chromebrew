...
class Libproxy < Meson
  ...
  binary_url({
    aarch64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libproxy/0.5.3_armv7l/libproxy-0.5.3-chromeos-armv7l.tar.zst',
     armv7l: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libproxy/0.5.3_armv7l/libproxy-0.5.3-chromeos-armv7l.tar.zst',
     x86_64: 'https://gitlab.com/api/v4/projects/26210301/packages/generic/libproxy/0.5.3_x86_64/libproxy-0.5.3-chromeos-x86_64.tar.zst'
  })
  binary_sha256({
