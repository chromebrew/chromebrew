# Adapted from Arch Linux AUR eclipse-php PKGBUILD at:
# https://aur.archlinux.org/cgit/aur.git/tree/PKGBUILD?h=eclipse-php
require 'package'
...
class Eclipse_php < Package
  ...
  source_url 'https://www.eclipse.org/downloads/download.php?file=/technology/epp/downloads/release/2023-03/R/eclipse-php-2023-03-R-linux-gtk-x86_64.tar.gz&r=1'
  source_sha256 'a2ee6de39528ef6445ef091d626d63d00a116a0b4dbf0fcd257030a0b3080123'
  ...
  def self.preflight
    conflicts = %w[eclipse_cpp eclipse_java]
