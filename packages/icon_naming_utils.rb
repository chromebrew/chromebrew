...
class Icon_naming_utils < Package
  ...
  binary_url ({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/icon_naming_utils-0.8.90-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/icon_naming_utils-0.8.90-chromeos-armv7l.tar.xz',
       i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/icon_naming_utils-0.8.90-chromeos-i686.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/icon_naming_utils-0.8.90-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
