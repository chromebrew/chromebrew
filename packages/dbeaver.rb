...
class Dbeaver < Package
  ...
  source_url ({
    x86_64: 'https://github.com/dbeaver/dbeaver/releases/download/21.3.5/dbeaver-ce-21.3.5-linux.gtk.x86_64.tar.gz'
  })
  source_sha256 ({
    x86_64: 'a6e3d11d6e9942855a117965b37b3e5e7357e413736a7b7a383582af9df65402'
  })
