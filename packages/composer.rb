...
class Composer < Package
  ...
  def self.install
    ...
    abort 'Checksum mismatch. :/ Try again.'.lightred unless Digest::SHA256.hexdigest( File.read('composer') ) == '72524ccebcb071968eb83284507225fdba59f223719b2b3f333d76c8a9ac6b72'
