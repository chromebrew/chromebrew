...
class Ldc < Package                 # The first character of the class name must be upper case
  ...
  binary_url ({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/ldc-1.7.0-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/ldc-1.7.0-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/ldc-1.7.0-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/ldc-1.7.0-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
