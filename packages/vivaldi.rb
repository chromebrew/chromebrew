...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'ba4db12ca9246150215252089fdd4d23efd130f4a8376a50399b338d577c3a4e'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '1306ab1cb6b5a532962b50d778378ad82c1cfddb3017b71896abbd04c222a4b5'
  end
