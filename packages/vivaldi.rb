...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '97a9cdf93538cef9e46d5dbb677828141ce6620b2a9e30addb2f9462f0697746'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '3961f785aec7b1ab8fec71dd681069117cd8a135e8fbf939a7d53331e03b54c9'
  end
