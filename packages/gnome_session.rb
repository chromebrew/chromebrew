...
class Gnome_session < Package
  ...
  binary_url({
    aarch64: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/gnome_session-40.beta-chromeos-armv7l.tar.xz',
     armv7l: 'https://downloads.sourceforge.net/project/chromebrew/armv7l/gnome_session-40.beta-chromeos-armv7l.tar.xz',
     x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/gnome_session-40.beta-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
