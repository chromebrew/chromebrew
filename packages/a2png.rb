...
class A2png < Autotools
  ...
  def self.patch
    ...
    Dir.chdir 'src' do
      ...
      Downloader.download 'https://cgit.freebsd.org/ports/plain/graphics/a2png/files/patch-src_image.h?id=06dfcbd2cbebaf3b3b81744ed8adaa903f1b24b7', '86d2cb207854649c486485d215ffc6758a4af6ab9b1acd5f6b266dd793f5c80e', 'patch-src_image.h'
      system 'patch -i patch-src_image.h'
      # FreeBSD patch to avoid C99 inline semantics.
      Downloader.download 'https://cgit.freebsd.org/ports/plain/graphics/a2png/files/patch-src_image.c?id=06dfcbd2cbebaf3b3b81744ed8adaa903f1b24b7', 'fece9703dbc73447135bbb9bc2fd4d3af6052f8025e516fff0592257aa1377e0', 'patch-src_image.c'
      Downloader.download 'https://cgit.freebsd.org/ports/plain/graphics/a2png/files/patch-src_parse.c?id=06dfcbd2cbebaf3b3b81744ed8adaa903f1b24b7', '65d0bf84b659381b18536498bf82d83386fc347ac80b374f1393eaf1dc5d80b2', 'patch-src_parse.c'
