...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 '9d71630e819a188a7d70676e4b08c17b8d6e97c1b6d3b59788be99f6dc062ae8'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 '7535e9a519ff6e5f87615ceacab2815dbd9801ac34951264c007ae91a96fddae'
  end
