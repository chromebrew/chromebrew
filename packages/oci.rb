...
class Oci < Package
  ...
  binary_url ({
      i686: 'https://downloads.sourceforge.net/project/chromebrew/i686/oci-2.4.23-chromeos-i686.tar.xz',
    x86_64: 'https://downloads.sourceforge.net/project/chromebrew/x86_64/oci-2.4.23-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
