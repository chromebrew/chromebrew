...
class Glib < Package
  ...
  def self.install
    ...
    FileUtils.cd("#{CREW_DEST_PREFIX}/include") do
      system "cp -r glib-2.0/* ."
      system "cp #{CREW_DEST_LIB_PREFIX}/glib-2.0/include/glibconfig.h ."
      system "rm -rf #{CREW_DEST_LIB_PREFIX}/glib-2.0/"
      system "rm -rf #{CREW_DEST_LIB_PREFIX}/gio/"
