...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'f3af5b7cc192db0d69080b3c4348bc83cca3a39bd31f2beb29cf4e5c7bb119e9'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'f8acb92f5346ec0a7b4086b2f6709d1b1430ace9f0a27c1439443ecf6afdc96a'
  end
