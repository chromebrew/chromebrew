...
class Vivaldi < Package
  ...
  when 'aarch64', 'armv7l'
    arch = 'armhf'
    source_sha256 'f4110bcc15399ba5d8da56259b28cdf5e3b84a95c9baa8ca0039128a51900ba0'
  when 'x86_64'
    arch = 'amd64'
    source_sha256 'c7ee975bd55cd02d611c5071e98d3d0ccd8367e012650037feb365e685313cd0'
  end
