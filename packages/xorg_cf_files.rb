...
class Xorg_cf_files < Package
  ...
  binary_url ({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/xorg_cf_files-1.0.6-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/xorg_cf_files-1.0.6-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/xorg_cf_files-1.0.6-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/xorg_cf_files-1.0.6-chromeos-x86_64.tar.xz',
  })
  binary_sha256 ({
