...
class Gst_editing_services < Package
  ...
  binary_url({
    aarch64: 'https://github.com/chromebrew/binaries/raw/main/armv7l/gst_editing_services-1.18.4-chromeos-armv7l.tar.xz',
     armv7l: 'https://github.com/chromebrew/binaries/raw/main/armv7l/gst_editing_services-1.18.4-chromeos-armv7l.tar.xz',
       i686: 'https://github.com/chromebrew/binaries/raw/main/i686/gst_editing_services-1.18.4-chromeos-i686.tar.xz',
     x86_64: 'https://github.com/chromebrew/binaries/raw/main/x86_64/gst_editing_services-1.18.4-chromeos-x86_64.tar.xz'
  })
  binary_sha256({
